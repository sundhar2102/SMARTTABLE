...
import { reconcileCleaningTables, reconcileNoShowReservations } from './services/waitTimeService.js';
...
httpServer.listen(PORT, async () => {
  ...
  // Clean up expired cleaning tables & 15-min no-shows in background every 10 seconds
  setInterval(() => {
    reconcileCleaningTables(io);
    reconcileNoShowReservations(io);
  }, 10000);
});
